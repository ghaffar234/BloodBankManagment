...
public class DeleteDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Blood Bank mangment System");
        setUndecorated(true);
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(281, 6, 323, -1));

        jLabel2.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Donor Id");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 60, 79, -1));
        ...
        getContentPane().add(DonorId, new org.netbeans.lib.awtextra.AbsoluteConstraints(206, 56, 216, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(453, 53, 111, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 103, 726, 10));

        jLabel3.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 102, 102));
        jLabel3.setText("FullName");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 124, -1, 16));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(9, 210, -1, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 308, 96, -1));

        jLabel8.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 102, 102));
        jLabel8.setText("Email");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 123, 41, -1));

        jLabel9.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setText("Blood Group");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 164, -1, -1));

        jLabel10.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 102, 102));
        jLabel10.setText("City");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 210, 48, -1));

        jLabel11.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 102, 102));
        jLabel11.setText("Compelete Address");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 264, -1, -1));

        jLabel12.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 102, 102));
        jLabel12.setText("Gender");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 353, 96, 16));

        FullName.setBackground(new java.awt.Color(255, 255, 255));
        FullName.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(FullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 119, 219, -1));
        ...
        getContentPane().add(FatherName, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 160, 219, -1));

        MotherName.setBackground(new java.awt.Color(255, 255, 255));
        MotherName.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(MotherName, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 206, 219, -1));

        MobileNumber.setBackground(new java.awt.Color(255, 255, 255));
        MobileNumber.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(MobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, 217, -1));

        DateOfBirth.setBackground(new java.awt.Color(255, 255, 255));
        DateOfBirth.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(DateOfBirth, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 304, 217, -1));

        Gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Others" }));
        getContentPane().add(Gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 349, 217, -1));

        Email.setBackground(new java.awt.Color(255, 255, 255));
        Email.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(Email, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 119, 220, -1));

        BloodGroup.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-" }));
        getContentPane().add(BloodGroup, new org.netbeans.lib.awtextra.AbsoluteConstraints(474, 161, 220, -1));

        City.setBackground(new java.awt.Color(255, 255, 255));
        City.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(City, new org.netbeans.lib.awtextra.AbsoluteConstraints(474, 206, 220, -1));

        CompleteAddress.setBackground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(473, 285, 217, 112));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 409, 726, 10));

        jButton2.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jButton2.setForeground(new java.awt.Color(0, 0, 0));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BloodBankManagment/delete.png"))); // NOI18N
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(43, 431, 103, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 431, -1, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(564, 431, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String donorIdToDelete = DonorId.getText();

DonorDirectory.deleteDonor(donorIdToDelete);
    DonorId.setText("");
    FullName.setText("");
    FatherName.setText("");
    MotherName.setText("");
